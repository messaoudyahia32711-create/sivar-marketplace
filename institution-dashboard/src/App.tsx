...
import InstitutionStorePage from './pages/InstitutionStorePage/InstitutionStorePage'
  ...
  return (
    <BrowserRouter basename="/">
      <Routes>
        ...
        {/* ── Public Institution Store Page (بدون مصادقة) ── */}
        <Route path="/store/:username" element={<InstitutionStorePage />} />
